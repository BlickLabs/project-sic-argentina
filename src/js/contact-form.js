...
$('form[name="sic-contact-form"]').validate({
  ...
  submitHandler: function(form) {
    ...
    $.ajax({
      type: 'POST',
      url: 'https://sicdeargentina.com.ar/integracion-formularios/contacto-spanol.php',
      data: formData,
      processData: false,
      contentType: false,
      cache: false
...
$('form[name="sic-contact-form-en"]').validate({
  ...
  submitHandler: function(form) {
    ...
    $.ajax({
      type: 'POST',
      url: 'https://sicdeargentina.com.ar/integracion-formularios/contacto-ingles.php',
      data: formData,
      processData: false,
      contentType: false,
      cache: false
