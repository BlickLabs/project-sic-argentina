...
function doSomething(scroll_pos) {
  if (window.location.pathname === '/index.html' || window.location.pathname === '/index-en.html' || window.location.pathname === '/' || window.location.pathname === '/project-sic-argentina/index.html' || window.location.pathname === '/project-sic-argentina/index-en.html' || window.location.pathname === '/project-sic-argentina/') {
    if (scroll_pos > 30) {
